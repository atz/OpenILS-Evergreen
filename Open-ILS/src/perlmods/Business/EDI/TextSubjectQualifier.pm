package Business::EDI::TextSubjectQualifier;
...
sub get_codes {
    ...
    AAH => ['Customs information',
        '[4034] Information entered by Customs on the CIM. Note: 1. This code value will be removed effective with directory D.06A' ],
